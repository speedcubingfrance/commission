...
\lfoot{}
\cfoot{Commission Championnats de France}
\rfoot{\thepage}
...
L'équipe sélectionnée par la Commission pour organiser les Championnats de France en sera notifiée environ une semaine avant.

La décision sera rendue publique lors des Championnats de France de l'édition précédente. L'annonce officielle sera faite conjointement par un membre de l'équipe organisatrice et par un membre de la Commission. Une fois l'annonce officielle passée, il sera à la charge de l'équipe organisatrice d'annoncer l'événement par les voies de communication de son choix (forums, réseaux sociaux, …) dans un délai d'une semaine.
